 ...
 * @author nv3ob61
 */
public class DiscVisitor implements Visitor {
  ...
  public double visitor(Shirt shirt) {
    System.out.println("Shirt final price with discount: ");
  ...
  public double visitor(Tshirt tshirt) {
    System.out.println("T-Shirt final price with discount: ");
  ...
  public double visitor(Jacket jacket) {
    System.out.println("Jacket final price with discount: ");
